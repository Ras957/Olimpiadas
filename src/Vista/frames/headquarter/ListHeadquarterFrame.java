...
public class ListHeadquarterFrame extends javax.swing.JFrame {
    ...
    public ListHeadquarterFrame(DAOManager manager) throws DAOException {
        initComponents();
        this.manager = manager;
        this.model = new HeadquarterTableModel(manager.getHeadquarterDAO());
        getData();
    ...
    private Headquarter getSelectedHeadquarter() throws DAOException {
        ...
        return manager.getHeadquarterDAO().get(id);
    }
    ...
    public static void main(String args[]) throws Exception {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            try {
                new ListHeadquarterFrame(manager).setVisible(true);
            } catch (DAOException ex) {
                ex.getMessage();
            }
        });
