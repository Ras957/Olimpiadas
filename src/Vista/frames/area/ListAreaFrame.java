...
public class ListAreaFrame extends javax.swing.JFrame {
    ...
    public ListAreaFrame(DAOManager manager) throws DAOException {
        initComponents();
        this.manager = manager;
        this.model = new AreaTableModel(manager.getAreaDAO());
        getData();
        this.tabla.setModel(model);
        this.Details.setEdit(false);
        this.Details.setArea(null);
        this.Details.setComboModel(new MultiSportCenterComboModel(manager.getMultiSportCenterDAO()));
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(Detalles, javax.swing.GroupLayout.PREFERRED_SIZE, 467, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(jToolBar2, javax.swing.GroupLayout.PREFERRED_SIZE, 951, javax.swing.GroupLayout.PREFERRED_SIZE)))
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
    ...
    private Area getSelectedArea() throws DAOException {
        ...
        return manager.getAreaDAO().get(id);
    }
    ...
    private void BDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BDeleteActionPerformed
        ...
        try {
            Area area = getSelectedArea();
            manager.getAreaDAO().delete(area);
            getData();
        } catch (DAOException ex) {
            ex.getMessage();
        }
    ...
    private void BSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BSaveActionPerformed
        try {
            if (Details.checkData()) {
                ...
                if (area.getId() == null) {
                    manager.getAreaDAO().insert(area);
                } else {
                    manager.getAreaDAO().modify(area);
                }
                Details.setArea(null);
    ...
    public static void main(String args[]) throws Exception {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new ListAreaFrame(manager).setVisible(true);
                } catch (DAOException ex) {
                    ex.printStackTrace();
                }
            }
