...
public class ListSportComplexFrame extends javax.swing.JFrame {
    ...
    public ListSportComplexFrame(DAOManager manager) throws DAOException {
        initComponents();
        this.manager = manager;
        this.model = new SportComplexTableModel(manager.getSportComplexDAO());
        getData();
        this.tabla.setModel(model);
        this.Details.setEdit(false);
        this.Details.setSportComplex(null);
        this.Details.setComboModel(new HeadquarterComboModel(manager.getHeadquarterDAO()));
    ...
    private SportComplex getSelectedSportComplex() throws DAOException {
        ...
        return manager.getSportComplexDAO().get(id);
    }
    ...
    private void BDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BDeleteActionPerformed
        ...
        try {
            SportComplex sportComplex = getSelectedSportComplex();
            manager.getSportComplexDAO().delete(sportComplex);
            getData();
        } catch (DAOException ex) {
            ex.getMessage();
        }
        ...
        try {
            if (Details.checkData()) {
                ...
                if (sportComplex.getId() == null) {
                    manager.getSportComplexDAO().insert(sportComplex);
                } else {
                    manager.getSportComplexDAO().modify(sportComplex);
                }
                Details.setSportComplex(null);
    ...
    public static void main(String args[]) throws Exception {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            try {
                new ListSportComplexFrame(manager).setVisible(true);
            } catch (DAOException ex) {
                ex.getMessage();
            }
        });
