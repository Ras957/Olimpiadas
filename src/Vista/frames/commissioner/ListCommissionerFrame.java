...
public class ListCommissionerFrame extends javax.swing.JFrame {
    ...
    public ListCommissionerFrame(DAOManager manager) throws DAOException {
        initComponents();
        this.manager = manager;
        this.model = new CommissionerTableModel(manager.getCommissionerDAO());
        getData();
    ...
    private Commissioner getSelectedCommissioner() throws DAOException {
        int id = (int) tabla.getValueAt(tabla.getSelectedRow(), 0);
        return manager.getCommissionerDAO().get(id);
    }
    ...
    private void BDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BDeleteActionPerformed
        ...
        try {
            Commissioner commissioner = getSelectedCommissioner();
            manager.getCommissionerDAO().delete(commissioner);
            getData();
        } catch (DAOException ex) {
            ex.getMessage();
        }
        ...
        try {
            if (Details.checkData()) {
                ...
                if (commissioner.getId() == null) {
                    manager.getCommissionerDAO().insert(commissioner);
                } else {
                    manager.getCommissionerDAO().modify(commissioner);
                }
                Details.setCommissioner(null);
    ...
    public static void main(String args[]) throws Exception {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            try {
                new ListCommissionerFrame(manager).setVisible(true);
            } catch (DAOException ex) {
                ex.printStackTrace();
            }
        });
