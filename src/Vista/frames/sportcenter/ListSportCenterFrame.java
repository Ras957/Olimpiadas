...
public class ListSportCenterFrame extends javax.swing.JFrame {
    ...
    public ListSportCenterFrame(DAOManager manager) throws DAOException  {
        initComponents();
        this.manager = manager;
        this.model = new SportCenterTableModel(manager.getSportCenterDAO());
        getData();
    ...
    private SportCenter getSelectedSportCenter() throws DAOException {
        ...
        return manager.getSportCenterDAO().get(id);
    }
    ...
    private void BDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BDeleteActionPerformed
        ...
        try {
            SportCenter sportCenter = getSelectedSportCenter();
            manager.getSportCenterDAO().delete(sportCenter);
            getData();
        } catch (DAOException ex) {
            ex.getMessage();
        }
    ...
    private void BSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BSaveActionPerformed
        try {
            if (Details.checkData()) {
                ...
                if (sportCenter.getId() == null) {
                    manager.getSportCenterDAO().insert(sportCenter);
                } else {
                    manager.getSportCenterDAO().modify(sportCenter);
                }
                Details.setSportCenter(null);
    ...
    public static void main(String args[]) throws Exception {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            try {
                new ListSportCenterFrame(manager).setVisible(true);
            } catch (DAOException ex) {
                ex.getMessage();
            }
        });
