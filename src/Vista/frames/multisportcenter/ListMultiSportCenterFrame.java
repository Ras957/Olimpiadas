 ...
 */
public class ListMultiSportCenterFrame extends javax.swing.JFrame {

    private DAOManager manager;
    private MultiSportCenterTablaModel model;
    
    public ListMultiSportCenterFrame(DAOManager manager) throws DAOException {
        initComponents();
        this.manager = manager;
        this.model = new MultiSportCenterTablaModel(manager.getMultiSportCenterDAO());
        getData();
        this.tabla.setModel(model);
        this.Details.setEdit(false);
        this.Details.setMultiSportCenter(null);
        this.Details.setComboModel(new SportComplexComboModel(manager.getSportComplexDAO()));
    ...
    public final void getData() throws DAOException {
        ...
        Registros.setText(model.getRowCount() + " polideportivos visibles");
    }
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(Detalles, javax.swing.GroupLayout.PREFERRED_SIZE, 363, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private MultiSportCenter getSelectedMultiSportCenter() throws DAOException {
        int id = (int) tabla.getValueAt(tabla.getSelectedRow(), 0);
        return manager.getMultiSportCenterDAO().get(id);
    }
    
    private void BAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BAddActionPerformed
        tabla.clearSelection();
        Details.setMultiSportCenter(null);
        Details.loadData();
    ...
    private void BEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BEditActionPerformed
        try {
            MultiSportCenter multiSportCenter = getSelectedMultiSportCenter();
            Details.setMultiSportCenter(multiSportCenter);
    ...
    private void BDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BDeleteActionPerformed
        if (JOptionPane.showConfirmDialog(rootPane, "¿Seguro que quieres borrar "
            + "este polideportivo?", "Borrar Polideportivo", JOptionPane.YES_NO_OPTION,
            JOptionPane.QUESTION_MESSAGE) == JOptionPane.YES_OPTION) {
        try {
            MultiSportCenter multiSportCenter = getSelectedMultiSportCenter();
            manager.getMultiSportCenterDAO().delete(multiSportCenter);
            getData();
        } catch (DAOException ex) {
            ex.getMessage();
        }
    ...
    private void BSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BSaveActionPerformed
        try {
            if (Details.checkData()) {
                Details.saveData();
                MultiSportCenter multiSportCenter = Details.getMultiSportCenter();
                if (multiSportCenter.getId() == null) {
                    manager.getMultiSportCenterDAO().insert(multiSportCenter);
                } else {
                    manager.getMultiSportCenterDAO().modify(multiSportCenter);
                }
                Details.setMultiSportCenter(null);
    ...
    public static void main(String args[]) throws Exception {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            try {
                new ListMultiSportCenterFrame(manager).setVisible(true);
            } catch (DAOException ex) {
                ex.getMessage();
            }
        });
    ...
    private Vista.frames.multisportcenter.MultiSportCenterDetailsPanel Details;
